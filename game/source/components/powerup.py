...
class Mushroom(Powerup):
    def __init__(self, x, y):
        Powerup.__init__(
            self, x, y, setup.GFX[c.ITEM_SHEET], [(0, 0, 16, 16)], c.SIZE_MULTIPLIER
        )
...
class LifeMushroom(Mushroom):
    def __init__(self, x, y):
        Powerup.__init__(
            self, x, y, setup.GFX[c.ITEM_SHEET], [(16, 0, 16, 16)], c.SIZE_MULTIPLIER
        )
...
class FireFlower(Powerup):
    def __init__(self, x, y):
        ...
        Powerup.__init__(
            self, x, y, setup.GFX[c.ITEM_SHEET], frame_rect_list, c.SIZE_MULTIPLIER
        )
